...
import (
	...
	"ocpack/pkg/mirror/additional"
	"ocpack/pkg/mirror/api/v2alpha1"
	"ocpack/pkg/mirror/archive"
	"ocpack/pkg/mirror/batch"
	"ocpack/pkg/mirror/clusterresources"
	"ocpack/pkg/mirror/config"
	"ocpack/pkg/mirror/consts"
	"ocpack/pkg/mirror/customsort"
	"ocpack/pkg/mirror/delete"
	"ocpack/pkg/mirror/emoji"
	"ocpack/pkg/mirror/helm"
