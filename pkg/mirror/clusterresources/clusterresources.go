...
import (
	...
	cm "ocpack/pkg/mirror/api/kubernetes/core"
	ofv1 "ocpack/pkg/mirror/api/operator-framework/v1"
	ofv1alpha1 "ocpack/pkg/mirror/api/operator-framework/v1alpha1"
	"ocpack/pkg/mirror/api/v2alpha1"
	updateservicev1 "ocpack/pkg/mirror/clusterresources/updateservice/v1"
	"ocpack/pkg/mirror/emoji"
	"ocpack/pkg/mirror/image"
	clog "ocpack/pkg/mirror/log"
	"ocpack/pkg/mirror/parser"
	"ocpack/pkg/mirror/version"
